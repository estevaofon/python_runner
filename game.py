...
SCREEN_WIDTH, SCREEN_HEIGHT = (800, 340)
...
link_sprite_path = os.path.join(BASEDIR, "images/sprites", "cavalgar.png")
rex = Animation(link_sprite_path)
rex.create_animation(3, 0, 87, 68, "run", duration=180, rows=1, cols=2)
rex.x = 150
rex.y = 250
...
if __name__ == '__main__':
    while True:
        ...
        screen.blit(surface, (0, 0))
        screen.blit(bg, (-20, -5))
        rex_rect = pygame.Rect(rex.x+20, rex.y, 40, 60)
